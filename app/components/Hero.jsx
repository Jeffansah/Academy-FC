...
const Hero = () => {
  return (
    <div id="hero" className="w-full h-full relative bg-contain bg-center">
      <Image
        layout="fill"
        src={player}
        alt="hero"
      ...
      >
        ...
        <h1 className="font-black min-w-[900px] text-6xl text-urbanist text-center mt-4">
          YOUR FOOTBALL JOURNEY <span className="text-theme">BEGINS HERE</span>
        </h1>
        {/* <p className="mt-4 text-center max-w-[700px] mx-auto text-[15px] text-secondary">
          Crafting the Next Generation of Football Heroes: Harnessing Potential,
          Inspiring Greatness, Celebrating Teamwork
        </p> */}
